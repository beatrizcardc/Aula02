...
public class DesvioComposto {
	...
	public static void main(String[] args) {
		...
		if (doacao < 1000) {
			//Aqui fica a parte verdadeira do if, o que acontece se a doação for menor que 1000
			investimento = doacao * 0.05;
			usoImediato = doacao - investimento;
		}else {
			//Aqui fica o que acontecerá se o teste for FALSO, se a doacao for maior ou igual a 1000
